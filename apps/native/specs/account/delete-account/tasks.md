...
- `rg "✅" apps/native/specs/account/delete-account/tasks.md | wc -l` ≥ 11(T0-T11 + T12 自身)
...
1. `cp -r ~/Downloads/account-center/. apps/native/specs/account/delete-account/design/source/`
...
- `ls apps/native/specs/account/delete-account/design/source/project/` 含 `DeleteCancel Preview.html` + `tailwind.config.js` + `IOSFrame.tsx` + `preview/` ✓
- `wc -l apps/native/specs/account/delete-account/design/handoff.md` ≥ 100 行 ✓
- `rg "PHASE 2 T_mock ✅" apps/native/specs/account/delete-account/tasks.md` 命中 ✓
...
1. 改 `apps/native/specs/account/delete-account/plan.md` § UI 段:
...
- `rg "PHASE 1 占位版" apps/native/specs/account/delete-account/plan.md` 0 命中(已替换为 PHASE 2 完整版)
- `rg "✅" apps/native/specs/account/delete-account/tasks.md | wc -l` ≥ 16(T0-T10 + T12 + T_mock + T13/T14/T15/T16-doc = 16,T11 + T16-smoke 仍 🟡)
...
- `rg "✅" apps/native/specs/account/delete-account/tasks.md` 加 1 (T16-smoke ✅) ✓
