...
| T_doc1   | [Inspiration]               | 4 张参考截图 + `notes.md` 决策留痕                                            | `apps/native/specs/account/profile/design/inspiration/`          | ✅ 本 PR              |
| T_doc2   | [Spec]                      | 写 spec.md(IA + User Flow + 21 + 5 Clarifications + 18 FR + 10 SC)            | `apps/native/specs/account/profile/spec.md`                      | ✅ 本 PR              |
| T_doc3   | [Plan]                      | 写 plan.md(7 关键决策 + 文件清单 + UI 段 4 边界占位)                          | `apps/native/specs/account/profile/plan.md`                      | ✅ 本 PR              |
| T_doc4   | [Tasks]                     | 写本文件 — T1-T9 实施步骤 + T_mock+ PHASE 2 占位空表                          | `apps/native/specs/account/profile/tasks.md`                     | ✅ 本 PR              |
...
| ✅T12    | [Plan]         | plan.md UI 段从 4 边界占位回填为完整 UI 结构                                                                           | `apps/native/specs/account/profile/plan.md` § UI 结构              | ✅ 本 PR |
| ✅T13    | [Visual smoke] | 4 状态截图(default / 滚动到 sticky / 切到 graph tab / 切到 kb tab + 顶 nav 各 disabled 反馈)                           | `runtime-debug/2026-05-07-my-profile-mockup-translation/`          | ✅       |
