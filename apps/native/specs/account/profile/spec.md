...
- **mockup PHASE 2** 由 Claude Design 单独产出(按 [`docs/experience/claude-design-handoff.md`](../../../../../docs/experience/claude-design-handoff.md) § 2.1b 合一页 prompt 模板),落 `apps/native/specs/account/profile/design/source-v1/`;本 PR **不**等 mockup
