...
- 既有参考：[`apps/native/specs/auth/onboarding/spec.md`](../onboarding/spec.md) — 类 1 spec 结构参照
- 既有参考：[`apps/native/specs/auth/login/spec.md`](../login/spec.md) — form 类 1 spec 参照
