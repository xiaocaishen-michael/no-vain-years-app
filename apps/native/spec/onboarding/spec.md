...
- mockup PHASE 2 由 Claude Design 后续单独产出（按 [`docs/experience/claude-design-handoff.md`](../../../../docs/experience/claude-design-handoff.md) § 2.1b 合一页 prompt 模板），落 `apps/native/spec/onboarding/design/source-v1/`；本 PR **不**等 mockup
